...
QT_INIT_METAOBJECT const QMetaObject octomap_rviz_plugin::OccupancyGridDisplay::staticMetaObject = { {
    &rviz::Display::staticMetaObject,
    qt_meta_stringdata_octomap_rviz_plugin__OccupancyGridDisplay.data,
    qt_meta_data_octomap_rviz_plugin__OccupancyGridDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
