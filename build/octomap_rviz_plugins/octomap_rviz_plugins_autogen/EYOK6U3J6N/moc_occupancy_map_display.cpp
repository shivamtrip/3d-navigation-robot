...
QT_INIT_METAOBJECT const QMetaObject octomap_rviz_plugin::OccupancyMapDisplay::staticMetaObject = { {
    &rviz::MapDisplay::staticMetaObject,
    qt_meta_stringdata_octomap_rviz_plugin__OccupancyMapDisplay.data,
    qt_meta_data_octomap_rviz_plugin__OccupancyMapDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
